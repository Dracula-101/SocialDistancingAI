...
from region_selector import generate_frame
...
if __name__ == '__main__':
    ...
    if region == 0:
        ...
        exit()
    cap = cv2.VideoCapture(f"vid_short{region}.mp4")
    ...
    while cap.isOpened():
        ...
        text = "Social-distancing Index: " + \
            str(np.round(100 * sc_index, 1)) + "%"
        pedestrian_detect, last_h = put_text(
            pedestrian_detect, text, text_offset_y=last_h)
